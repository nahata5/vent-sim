...
describe('StreamStore ring buffers', () => {
  ...
  it('trims events and breaths older than the window', () => {
    ...
    s.addBreaths([{ index: 0, tStart: 0.1, triggerCause: 'time', tInspEnd: 0.6, tPauseEnd: 0.6, cycleCause: 'time', tEnd: 2.0, vtiTrue: 0.4, vteTrue: 0.4, vtiMeasured: 0.4, vteMeasured: 0.4, peakFlowMeasured: 0.5, ppeakMeasured: 20 }], []);
