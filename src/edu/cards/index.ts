...
export const CARDS: Record<PatternId, ExplainCard> = {
  'ineffective-effort': {
    ...
    causes: ['Intrinsic PEEP (COPD, short Te)', 'Over-assist: high PS, high Vt, long Ti', 'Weak effort, low drive, deep sedation, hypocapnia', 'Insensitive trigger or effort inside the refractory period'],
  ...
  'double-trigger': {
    ...
    causes: ['VC with a short Ti or a high flow', 'Low set Vt with a high drive (ARDS, 6 mL/kg)', 'Premature cycling in PSV (high ETS, low τ)'],
  ...
  'flow-starvation': {
    ...
    causes: ['VC with a peak flow of 30–45 L/min', 'High drive (Pmax 10–20)'],
